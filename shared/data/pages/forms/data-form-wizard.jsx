       ...
       <div className="">
         ...
         {goSteps === 0 && (
           ...
           <div className="row border" >
             ...
             <span className="Stepperh3 d-flex p-4"><span className="number number-display step3 me-2">1</span><span className="title " onClick={() => setGoSteps(0)}>Personal Information</span></span>
             <span className="Stepperh3 d-flex p-4"><span className="number number-display step2 me-2">2</span><span className="title Step1" onClick={() => setGoSteps(1)}>Billing Information</span></span>
             <span className="Stepperh3 d-flex p-4"><span className="number number-display step2 me-2">3</span><span className="title Step1" onClick={() => setGoSteps(2)}>Payment Details</span></span>
             </div>
