                                ...
                                <Row>
                                    <Col xl={6} lg={6} className="mb-5 pb-5 animation-zidex pos-relative">
                                        ...
                                        <h6 className="pb-3">
                                            ...
                                            you need to start from scratch with Nextjs, React and with lots of coding,
                                                            ...
                                                            <div className="counter-status">
                                                                ...
                                                                <div className="test-body text-center">
                                                                    ...
                                                                    <div className="counter-text">
                                                                        <h5 className="font-weight-normal mb-0 ">Nextjs Components</h5>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </Card.Body>
                                    ...
                                    <div className="sptb section bg-white" id="Features">
                                        <Container>
                                            <Row>
                                                ...
                                                <p className="text-default mb-5 text-center">The Sash Nextjs Admin Template comes with ready-to-use features that are completely easy-to-use for any user, even for a beginner.</p>
                                                <Row className="mt-7">
                                                    <Col lg={6} md={12}>
                                                    ...
                                                    <Col lg={6} md={12}>
                                                        <Card className="features main-features main-features-2 wow fadeInUp" data-wow-delay="0.1s">
                                                            ...
                                                            <div className="text-left">
                                                                ...
                                                                <p className="mb-0">
                                                                    We included multiple demos, preview video, and screen shots to give a quick overview of our Sash Nextjs Admin Template.
                                                                </p>
                                                            </div>
                                                        </Card>
                                                    </Col>
                                                    <Col lg={6} md={12}>
                                                        <Card className="features main-features main-features-11 wow fadeInUp" data-wow-delay="0.1s">
                                                            ...
                                                            <div className="text-left">
                                                                ...
                                                                <p className="mb-0">
                                                                    Different types of “Form Validation” are implemented in this Sash Nextjs Admin Template and used strict validation rules.
                                                                </p>
                                                            </div>
                                                        </Card>
                                                    </Col>
                                                    ...
                                                    <Col lg={6} md={12}>
                                                        <Card className="features main-features main-features-9 wow fadeInUp" data-wow-delay="0.1s">
                                                            ...
                                                            <div className="text-left">
                                                                <h4 className="fw-bold">2 Types of Charts</h4>
                                                                <p className="mb-0">
                                                                    We included nine (2) types of the best possible chart options for your project. You can customize with your requirement.
                                                                </p>
                                                            </div>
                                                        </Card>
                                                    </Col>
                                                    <Col lg={6} md={12}>
                                                        <Card className="features main-features main-features-12 mb-4 wow fadeInUp" data-wow-delay="0.1s">
                                                            ...
                                                            <div className="text-left">
                                                                ...
                                                                <p className="mb-0">
                                                                    The documentation provides clear-cut material for the Sash Nextjs Admin Template. The documentation is explained or instructed in such a way that every user can understand.
                                                                </p>
                                                            </div>
                                                        </Card>
                                                    </Col>
                                                ...
                                                <Card className="bg-transparent mb-0">
                                                    ...
                                                    <div className="demo-screen-skin code-quality" id="dependencies">
                                                        <div className="text-center p-0">
                                                            <h2 className="text-center fw-semibold text-white">Features Used in Sash Nextjs Admin Template</h2>
                                                            ...
                                                            <Col lg={12}>
                                                                <Row className="justify-content-center">
                                                                    <Col lg={9} as='p' className="text-default sub-text mb-7">
                                                                        The Sash Nextjs Admin Template is one of the modern dashboard templates.
                                                                            ...
                                                                            <Accordion className="bg-primary-transparent p-0 ">
                                                                                <Accordion.Item eventKey="0" className='mb-5 bg-primary-transparent'>
                                                                                    ...
                                                                                    <Accordion.Body className="pt-0">
                                                                                        <p>
                                                                                            The Sash – Nextjs Admin & Dashboard Template is available in both vertical and horizontal menus.
                                                                                        ...
                                                                                        <Button href="#!"  variant='outline-primary' className="tx-13">Click here</Button>
                                                                                    </Accordion.Body>
                                                                                </Accordion.Item>
                                                                            </Accordion>
                                                                        </Col>
                                                                        <Col md={12} className="grid-item  px-0 mb-5">
                                                                            ...
                                                                            <Accordion className="bg-success-transparent p-0">
                                                                                <Accordion.Item eventKey="0" className='mb-5  bg-primary-transparent'>
                                                                                    ...
                                                                                    <Accordion.Body className="pt-0">
                                                                                        <p>
                                                                                            The Sash – Nextjs Admin & Dashboard Template is available in LRT & RTL versions with single assets. Using those single assets, it’s very easy to switch from one version to another version.
                                                                                        </p>
                                                                                        <p className="mt-2 mb-3">
                                                                                            <span className="fw-bold">Note: </span>Please Refer full Documentation
                                                                                            for more details.
                                                                                        </p>
                                                                                        <Button href="#!"  variant='outline-success' className="tx-13">Click here</Button>
                                                                        ...
                                                                        <Col md={12} className="grid-item  px-0 mb-5">
                                                                            ...
                                                                            <Accordion className="bg-info-transparent p-0">
                                                                                <Accordion.Item eventKey="0" className='mb-5  bg-primary-transparent'>
                                                                                    ...
                                                                                    <Accordion.Body className="pt-0">
                                                                                        <p>
                                                                                            The Sash – Nextjs Admin & Dashboard Template is available in different types of color styles.
                                                                                        ...
                                                                                        <a href="#!" variant='outline-info' className="btn btn btn-outline-info tx-13">Click here</a>
                                                                        ...
                                                                        <Col md={12} className="grid-item  px-0 mb-5">
                                                                            <Accordion className="bg-secondary-transparent p-0">
                                                                                <Accordion.Item eventKey="0" className='mb-5  bg-primary-transparent'>
                                                                                    ...
                                                                                    <Accordion.Body className="pt-0">
                                                                                        <p>
                                                                                            The Sash – Nextjs Admin & Dashboard Template is also available in two different types of layouts
                                                                                        ...
                                                                                        <Button href="#!"  variant='outline-secondary' className="tx-13">Click here</Button>
                                                                        ...
                                                                        <Col md={12} className="grid-item  px-0 mb-5">
                                                                            ...
                                                                            <Accordion className="bg-warning-transparent p-0">
                                                                                <Accordion.Item eventKey="0" className='mb-5  bg-primary-transparent'>
                                                                                    ...
                                                                                    <Accordion.Body className="pt-0">
                                                                                        <p>
                                                                                            The Sash – Nextjs Admin & Dashboard Template is also available in different types of Side Menu Styles.
                                                                                        ...
                                                                                        <Button href="#!"  variant='outline-warning' className="tx-13">Click here</Button>
                                                                        ...
                                                                        <Col md={12} className="grid-item  px-0 mb-5">
                                                                            <Accordion className="bg-danger-transparent p-0">
                                                                                <Accordion.Item eventKey="0" className='mb-5  bg-primary-transparent'>
                                                                                    ...
                                                                                    <Accordion.Body className="pt-0">
                                                                                        <p>
                                                                                            The Sash – Nextjs Admin & Dashboard Template is also available in two
                                                                                        ...
                                                                                        <Button href="#!"  variant='outline-danger' className="tx-13">Click here</Button>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5  bg-primary-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#!"  className="btn btn-outline-primary tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5 bg-success-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#!"  className="btn btn-outline-success tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5 bg-secondary-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#!"  className="btn btn-outline-secondary tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                                                ...
                                                                <Accordion>
                                                                    <Accordion.Item eventKey="0" className='mb-5 bg-danger-transparent'>
                                                                        ...
                                                                        <Accordion.Body>
                                                                            ...
                                                                            <Link href="#!"  className="btn btn-outline-danger tx-13">Click here</Link>
                                                                        </Accordion.Body>
                                                                    </Accordion.Item>
                                                                </Accordion>
                                                            </Col>
                                        ...
                                        <Container>
                                            <Row>
                                                ...
                                                <div className="text-center mt-5">
                                                    <Link href={`/components/pages/extension/blog/`} className="btn btn-outline-primary pt-2 pb-2" ><i className="fe fe-arrow-right mx-2"></i>Discover More</Link>
                                                            ...
                                                            <Card.Body className="pt-5 px-7">
                                                                <Row>
                                                                    ...
                                                                    <Col lg={9} className="text-end my-auto">
                                                                        <Link href="https://themeforest.net/item/sash-nextjs-admin-dashboard-template/43443261"  className="btn btn-pink w-lg pt-2 pb-2"><i className="fe fe-shopping-cart mx-2"></i>Buy Now
                                                                        </Link>
                                                                    </Col>
                                                                </Row>
                                                            </Card.Body>
                                            ...
                                            <Col lg={4} sm={12} md={4} className="">
                                                <div className="">
                                                    <Link href={`/components/dashboard/dashboard/`}>
                                                        <img loading="lazy" alt="logo" className="logo-2 mb-3" src="../../../assets/images/brand/logo-dark.png" />
                                                    </Link>
                                                    <Link href={`/components/dashboard/dashboard/`}>
                                                        <img loading="lazy" alt="logo" className="logo-3" src="../../../assets/images/brand/logo-white.png" />
                                                    </Link>
