...
<div className='header sticky app-header header1'>
        <div className="container-fluid main-container">
          <div className="d-flex">
            <Link href="#!" aria-label="Hide Sidebar" className="app-sidebar__toggle" data-bs-toggle="sidebar" onClick={() => SideMenuIcon()} />
                  ...
                  <div className="d-flex order-lg-2">
                    ...
                    <Dropdown className="shopping-cart">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <PerfectScrollbar style={{ height: "300px" }}>
                          <Link href={`/components/e-commerce/shopping-cart/`} className="d-flex p-4 dropdown-item">
                    ...
                    <Dropdown className="notifications">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <div className="notifications-menu">
                          <Link className="dropdown-item d-flex" href={`/components/pages/notifications-list`}>
                            <div
                        ...
                        <div className="dropdown-divider m-0"></div>
                           <Link className="dropdown-item text-center p-3 text-muted dropdown-item" href={`/components/pages/notifications-list`}>
                    ...
                    <Dropdown className=" message">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <div className="message-menu">
                          <Link className="dropdown-item d-flex" href={`/components/apps/chat/`}>
                            <img
                        ...
                        <div className="dropdown-divider m-0"></div>
                        <Link href="#!" className="text-center p-3 text-muted">See all
                          Messages</Link>
                      </Dropdown.Menu>
                    </Dropdown>
                    ...
                    <Dropdown className=" profile-1">
                      ...
                      <Dropdown.Menu className="dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <Link className="dropdown-item" href={"#!"} onClick={() => { routeChange(); }}>
